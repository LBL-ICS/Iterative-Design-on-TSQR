...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Ident(_CURSOR_)
       tree position: line 280 of file:///C:/Users/blair/OneDrive/Documents/Desktop/iterative_tsqr/src/main/scala/tsqr_fsm.scala
            tree tpe: <error>
...
== Source file context for tree position ==
   ...
   277             dmx1_mem_ena_wire := mx_cnt(0) & (tr_cnt >=(TR_CY_MACRO).U ) & (tr_cnt < ((TR_CY_MACRO).U + tr_cy))
   278             rtri_mem_ena_wire := (tr_cnt >=(TR_CY_MACRO).U ) & (tr_cnt < ( (TR_CY_MACRO).U+ tr_cy))
   279         }
   280 _CURSOR_
   281 
